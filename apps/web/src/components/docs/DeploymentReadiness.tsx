...
const targets = [
  ...
  ["RAG embeddings", "OpenAI/pgvector optional; keyword fallback default"],
  ["Agent execution", "Deterministic workflow with optional LLM summaries"],
];
  ...
  return (
    <section id="deployment" className="glass-card p-6">
      ...
      <p className="mt-3 text-sm leading-relaxed" style={{ color: "var(--color-text-secondary)" }}>
        The submission is prepared for a Vercel frontend, Render FastAPI backend, and Supabase Postgres database. The demo remains safe: external ad-platform APIs are not called, secrets stay in environment variables, and simulated execution is clearly labeled.
      </p>
